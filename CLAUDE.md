...
DO NOT COMMIT OR PUSH ANYTHING YOURSELF! ALL CHANGES DO IN MASTER BRANCH!

нативный мост отдаёт ответы с PascalCase @type (TextEntity, TextEntityTypeBold), а на отправку TDLib ждёт lowercase-first (textEntity, textEntityTypeBold)

Твоя основная документация - это https://core.telegram.org/tdlib/getting-started
